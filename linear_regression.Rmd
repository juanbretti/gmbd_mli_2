...
\
Was also removed `r data_3_temp %>% filter_at(vars(Outer, Elevator, Bedrooms, Floor), any_vars(is.na(.))) %>% nrow()` properties because no values at any of the relevant variables, i.e., **Outer**, **Elevator**, **Bedrooms**, **Floor**).
